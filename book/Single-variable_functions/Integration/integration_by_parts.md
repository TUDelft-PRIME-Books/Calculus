...
\begin{align*}
\int\arccos(x)\,dx&=\int\left(\frac{1}{\pi}-\arcsin(x)\right)\,dx\\
...
&=\frac{1}{2}\int_{\pi/2}^{\pi}x\cos(x)\,dx.
\end{align*}

Now we use integration by parts to find that

\begin{align*}
\int_{\sqrt{\pi/2}}^{\sqrt{\pi}}t^3\cos(t^2)\,dt&=\frac{1}{2}\int_{\pi/2}^{\pi}x\cos(x)\,dx \\
&=\frac{1}{2}x\sin(x)\bigg|_{\pi/2}^{\pi}-\frac{1}{2}\int_{\pi/2}^{\pi}\sin(x)\,dx\\
&=-\frac{1}{4}\pi+\frac{1}{2}\cos(x)\bigg|_{\pi/2}^{\pi}\\
