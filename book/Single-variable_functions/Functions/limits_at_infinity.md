...
::::{applet}
:url: calculus/limits_at_infinity/a_function_with_limit_2_at_infinity
...
::::{applet}
:url: calculus/limits_at_infinity/sine_of_x_over_x_squared
...
::::{applet}
:url: calculus/limits_at_infinity/one_over_one_plus_e_to_the_minus_x
:name: Fig:LimitAtInfinity:Computationrules
:class: dark-light

An illustration of the function $f(x)=\dfrac{1}{1+e^{-x}}$ for large positive and negative values of $x$.
::::
...
::::{applet}
:url: calculus/limits_at_infinity/squeeze_theorem
...
::::{applet}
:url: calculus/limits_at_infinity/limit_of_arctan_at_infinity
