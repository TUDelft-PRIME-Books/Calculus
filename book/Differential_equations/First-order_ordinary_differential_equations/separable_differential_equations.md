...
::::::{prf:Example}
The differential equation $\displaystyle\frac{dy}{dx}=\frac{y}{x}$ with $x>0$ is separable. Note that $y=0$ is a solution. For $y\neq0$ we have:
...
::::::{prf:Example}
The differential equation $\dfrac{dy}{dx}=2xy$ is separable. Note that $y=0$ is a solution. For $y\neq0$ we have:
...
::::::{prf:Example}
The differential equation $\displaystyle\frac{dy}{dx}=2x(1+y^2)$ is separable:
...
&=\frac{1}{2}e^{-x^2}\sin(xt)\bigg|_0^{\infty}-\frac{1}{2}\int_0^{\infty}e^{-x^2}\,d\sin(xt)\\
...
$$
\begin{align*}
\frac{dP}{dt}=kP\left(1-\frac{P}{M}\right)&\quad\Longrightarrow\quad\frac{dP}{P\displaystyle\left(1-\frac{P}{M}\right)}=k\,dt\\
&\quad\Longrightarrow\quad\int\frac{M}{P(M-P)}\,dP=\int k\,dt.
\end{align*}
$$
...
$$
T(30)=15\;\Longleftrightarrow\;15=5+15e^{30k}\;\Longleftrightarrow\;30k=\ln\left(\frac{10}{15}\right)=\ln\left(\frac{2}{3}\right).
$$
...
2) $T(t)=10\;\Longleftrightarrow\;10=5+15e^{−0.0135t}\;\Longleftrightarrow\;−0.0135t=\ln\left(\frac{5}{15}\right)=\ln\left(\frac{1}{3}\right)$.
